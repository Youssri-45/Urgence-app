package md580ea292142268670a32291382dcaf680;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Xam.Plugin.DeviceManager.Droid.Listeners.DeviceListener, Xam.Plugin.DeviceManager.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", DeviceListener.class, __md_methods);
	}


	public DeviceListener () throws java.lang.Throwable
	{
		super ();
		if (getClass () == DeviceListener.class)
			mono.android.TypeManager.Activate ("Xam.Plugin.DeviceManager.Droid.Listeners.DeviceListener, Xam.Plugin.DeviceManager.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
